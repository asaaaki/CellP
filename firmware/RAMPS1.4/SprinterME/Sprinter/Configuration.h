...
float axis_steps_per_unit[] = {79.1628, 79.1628, 3200/1.25,750}; 
...
const bool min_software_endstops = false; //If true, axis won't move to coordi1.6nates less than zero.
